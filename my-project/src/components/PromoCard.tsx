export function PromoCard() {
  return (
    <div className="relative overflow-hidden rounded-xl h-40 sm:h-48 group cursor-pointer">
      <img
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-t-black p-4 sm:p-6 flex flex-col justify-end">
        <span className="text-blue-300 text-xs font-label-caps mb-1">
          Travel Insight
        </span>
        <h3 className="text-white text-base sm:text-h3 font-h3 leading-tight">
