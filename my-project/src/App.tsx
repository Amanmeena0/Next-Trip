...
export default function TripFlow() {
  ...
  return (
    <div className="min-h-screen text-foreground font-body antialiased">
      <Header />
      ...
      */}
      <main className="mx-auto max-w-7xl px-4 pb-28 pt-20 sm:px-6 sm:pb-32 md:pb-36 lg:px-8 lg:pt-24">
