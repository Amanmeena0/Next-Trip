  ...
  theme: {
    extend: {
      colors: {
        ...
        input: '#d9ccbb',
        primary: '#155e75',
        'primary-hover': '#0f4d60',
        'primary-foreground': '#f8fcfd',
        secondary: '#7c6b55',
        'secondary-foreground': '#fffaf4',
        accent: '#0f766e',
        'accent-foreground': '#f5fffd',
        muted: '#efe7da',
      ...
      fontSize: {
        ...
        h1: ['2.5rem', { lineHeight: '1.1', letterSpacing: '-0.03em', fontWeight: '800' }],
